...
const integrations = ["CRMs", "Websites", "Forms", "Databases", "Email", "Calendars", "Spreadsheets"];
const aiCapabilities = ["Classify", "Summarize", "Score", "Route", "Draft"];
      ...
      <section id="ai-integration-layer" aria-labelledby="integration-heading" className="pa-section" style={{ fontFamily: "'DM Sans', sans-serif", background: "#08090f", padding: "80px 40px", position: "relative", overflow: "hidden", boxSizing: "border-box" }}>
        <div style={{ maxWidth: "1100px", margin: "0 auto", position: "relative" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "12px" }}>
            ...
            <span style={{ fontSize: "11px", letterSpacing: "0.2em", textTransform: "uppercase" as const, color: "#C9A84C", fontWeight: 500 }}>AI + Integration Layer</span>
          </div>
          ...
          <p style={{ fontSize: "14px", color: "rgba(240,237,230,0.5)", lineHeight: 1.75, marginBottom: "40px", maxWidth: "640px" }}>
            Process automation delivers the most value when inputs, AI logic, integrations, and outputs work as one connected system — not as disconnected steps your team has to manage manually.
          </p>
          ...
          <div style={{ background: "rgba(201,168,76,0.05)", border: "1px solid rgba(201,168,76,0.2)", borderRadius: "14px", padding: "24px 28px" }}>
            ...
            <p style={{ fontSize: "13px", color: "rgba(240,237,230,0.6)", lineHeight: 1.75, margin: 0, maxWidth: "760px" }}>
              Not every step should be fully automated. The Prime Crafters designs human-in-the-loop approval paths for sensitive decisions, escalations, and exceptions — so automation stays practical, auditable, and safe for real business operations.
            </p>
