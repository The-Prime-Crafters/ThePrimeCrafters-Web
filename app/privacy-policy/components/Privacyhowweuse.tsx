        ...
        <div className="pp-hwu-inner">
          ...
          <div className="pp-hwu-header">
            ...
            <p className="pp-hwu-header-desc">
              Every piece of data The Prime Crafters holds has a specific, legitimate purpose.
              We never use personal data for advertising, audience profiling, or third-party marketing purposes.
            </p>
          </div>
