...
const PrivacyHero: React.FC = () => {
  ...
  At The Prime Crafters, your privacy is not an afterthought — it is
  built into everything we do. This policy explains clearly and
  honestly how we collect, use, store, and protect the information you
  share with us when you visit our website or engage our AI automation
  services.
</p>
