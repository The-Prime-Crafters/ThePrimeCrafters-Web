...
<div className="pp-commit-left">
  ...
  <p className="pp-commit-para">
    Your trust makes our work possible. The Prime Crafters is an AI
    automation agency that works closely with businesses to build
    intelligent systems — and we understand better than most how
    sensitive data can be.
  </p>

  <p className="pp-commit-para">
    We are committed to protecting the privacy of every visitor,
    enquirer, and client who interacts with us, whether through this
    website, our contact forms, discovery calls, or active project
    engagements. This policy covers what information we collect, why we
    collect it, how it is used, and what rights you have over it.
  </p>

  <p className="pp-commit-para">
    We do not sell your data. We do not use it for advertising. We
    handle it with the same care we would want applied to our own.
  </p>
</div>
          {/* RIGHT SIDE */}
