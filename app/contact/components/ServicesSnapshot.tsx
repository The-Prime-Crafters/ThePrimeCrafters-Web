...
const services = [
  {
    ...
    description:
      "Deploy intelligent voice agents that handle calls, qualify leads, and resolve support tickets — 24/7 without fatigue.",
    icon: (
  ...
  },
  {
    ...
    description:
      "Eliminate repetitive tasks and streamline complex multi-step processes with intelligent automation pipelines.",
    icon: (
      <svg viewBox="0 0 24 24" fill="none" className="h-6 w-6" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    title: "AI Chatbots",
    description:
      "Context-aware conversational AI that understands your business, engages visitors, and converts them into customers.",
    icon: (
      <svg viewBox="0 0 24 24" fill="none" className="h-6 w-6" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description:
      "Seamlessly connect your AI stack with Salesforce, HubSpot, Pipedrive, and more — keeping your data in sync.",
    icon: (
      <svg viewBox="0 0 24 24" fill="none" className="h-6 w-6" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description:
      "Purpose-built AI architectures trained on your data, tailored to your industry's unique requirements and scale.",
    icon: (
      <svg viewBox="0 0 24 24" fill="none" className="h-6 w-6" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    title: "AI Assistants",
    description:
      "Intelligent internal assistants that answer questions, surface insights, and keep your team operating at peak efficiency.",
    icon: (
      <svg viewBox="0 0 24 24" fill="none" className="h-6 w-6" stroke="currentColor" strokeWidth={1.5}>
        ...
        >
          ...
          >
            ...
            <p className="mt-4 max-w-xl text-sm leading-relaxed text-neutral-400 sm:text-base md:mt-5">
              Explore our AI automation solutions designed to optimize workflows,
              increase efficiency, and scale business operations with precision.
            </p>
          </div>
