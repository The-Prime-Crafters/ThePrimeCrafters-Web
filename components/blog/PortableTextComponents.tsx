...
export const portableTextComponents: PortableTextComponents = {
  ...
  list: {
    bullet: ({ children }) => (
      <ul className="list-none space-y-3 mb-8 pl-1">{children}</ul>
    ),
    number: ({ children }) => (
      <ol className="list-decimal space-y-3 mb-8 pl-4 marker:text-[#D4AF37]">{children}</ol>
    ),
  },
  listItem: {
    bullet: ({ children }) => (
      <li className="list-none flex gap-3 text-[#8a8a8a] text-[1.05rem] leading-[1.8]">
