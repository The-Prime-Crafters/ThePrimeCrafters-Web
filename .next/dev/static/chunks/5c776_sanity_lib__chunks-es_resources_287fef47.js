...
"[project]/prime/ThePrimeCrafters-Web/node_modules/sanity/lib/_chunks-es/resources.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
const structureLocaleStrings = (0, __TURBOPACK__imported__module__$5b$project$5d2f$prime$2f$ThePrimeCrafters$2d$Web$2f$node_modules$2f$sanity$2f$lib$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["defineLocalesResources"])("structure", {
    ...
    /** The text that appears for the action button to add the current document to the global bundle, this happens when user is viewing an anonymous bundle */ "banners.release.action.add-to-bundle": "Add to bundle",
   ...
   * */ "banners.release.navigate-to-edit-description-none": "This document is not part of any release",
    ...
    /** The text shown if there are no incoming references in the inspector */ "incoming-references-pane.no-references": "No incoming references found.",
    ...
    /** The tooltip text shown when a sort menu item references fields not present in the current schema */ "panes.document-list-pane.sort-order.disabled-reason": "This sorting option uses fields that are not part of this document type",
    ...
    /** The text when a publish operation succeeded in an anonymous version */ "panes.document-operation-results.operation-success_publishVersion": "Version was published",
...
//# sourceMappingURL=5c776_sanity_lib__chunks-es_resources_287fef47.js.map