...
3:T1289,
      ...
      0:{"buildId":"Sp4oMI8tyQ38m6bCa2RPE","rsc":["$","$1","c",{"children":[["$","main",null,{"children":[["$","$L2",null,{}],[["$","style",null,{"children":"$3"}],"$L4"],"$L5","$L6","$L7","$L8","$L9","$La","$Lb","$Lc","$Ld","$Le","$Lf"]}],["$L10","$L11","$L12","$L13"],"$L14"]}],"loading":null,"isPartial":false}
